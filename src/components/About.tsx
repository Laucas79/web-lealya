      ...
      <div className="wrap about-wrap" style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) minmax(0, 1.2fr)', gap: 80, alignItems: 'center' }}>
        ...
        <div>
          ...
          <p style={{ fontSize: 16, lineHeight: 1.75, color: 'var(--muted)', margin: '0 0 40px', maxWidth: 580 }}>
            Fundé Lealya para dar nombre a esa manera de trabajar: una figura que sirva de <em>puente</em> entre comprador y vendedor, defendiendo los intereses de ambos con criterio y calma.
          </p>
          <div style={{ display: 'flex', gap: 48, flexWrap: 'wrap', marginBottom: 40 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 14, lineHeight: 1.7 }}>Gestión integral end-to-end<br/>Compra · Venta · Mediación</div>
            </div>
          </div>
