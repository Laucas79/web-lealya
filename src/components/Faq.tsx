...
const FAQ = [
  ...
  ['¿En qué zonas trabajas?', 'Principalmente en el corredor norte de Madrid: La Moraleja, Ciudalcampo, Ciudad Santo Domingo y Fuente del Fresno — el eje de la A-1 / Carretera de Burgos. También trabajo con frecuencia en Valdebebas y Barajas. Para operaciones fuera de estas zonas, lo valoramos caso por caso.'],
